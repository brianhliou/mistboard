...
export const EN_REVIEW = {
  ...
  'broadcast.slow': 'Slow',
  'broadcast.blitz': 'Blitz',
  'broadcast.table': 'Table {n}',
  'broadcast.tableGame': 'Table {n} · Game {g}',
  'broadcast.allTeams': 'All teams',
  'broadcast.teamFilter': 'Show one team',
  'broadcast.roundMatches': "This round's matches",
  'broadcast.leagueTable': 'League table',
  'broadcast.matchBoards': 'Boards',
  'broadcast.teamLeague': 'Team league',
  'broadcast.timeControlMinSec': '{m} min + {s} sec / move',
  'broadcast.standingsLink': 'Standings',
  'broadcast.pageFirst': 'First page',
  'broadcast.pagePrev': 'Previous page',
  'broadcast.pageNext': 'Next page',
  'broadcast.pageLast': 'Last page',
  ...
  // Player pages (#458): record by colour, openings, head to head, the
  // rating history chart and the index filters.
  'broadcast.playerRecord': 'Record',
  'broadcast.playerOverall': 'Overall',
  'broadcast.playerAsRed': 'As red',
  'broadcast.playerAsBlack': 'As black',
  'broadcast.playerWon': 'Won',
  'broadcast.playerDrawn': 'Drawn',
  'broadcast.playerLost': 'Lost',
  'broadcast.playerOpenings': 'Openings',
  'broadcast.playerOpeningsNote': 'As the source classifies each game, by ECCO code.',
  'broadcast.playerShowAll': 'Show all {n}',
  'broadcast.playerShowFewer': 'Show fewer',
  'broadcast.playerEccoA': 'Flank openings',
  'broadcast.playerEccoB': 'Central Cannon, other defences',
  ...
  'broadcast.playerFilterBlack': 'Black',
  'broadcast.playerFilterOpponent': 'Opponent',
  'broadcast.playerFilterAnyOpponent': 'Any opponent',
  'broadcast.playerFilterOpening': 'Opening',
  'broadcast.playerFilterAnyOpening': 'Any opening',
  'broadcast.playerFilterClear': 'Clear',
  'broadcast.playerGamesShown': '{n} of {total} games',
  'broadcast.playerNoGames': 'No games in our archive yet',
  'broadcast.playerNoGamesBody':
    'The archive holds the national events we have broadcast since January 2026. This page fills in when {name} plays one.',
  'broadcast.playerListLabel': 'CXA list',
  'broadcast.playerListMen': "Men's list",
  'broadcast.playerListWomen': "Women's list",
  'broadcast.playerRatingHistory': 'Rating history',
  'broadcast.playerChartRating': '等级分 rating, 2019 to 2023',
  'broadcast.playerChartPoints': '竞赛积分 tournament points',
  'broadcast.playerChartNotListed': 'Not listed',
  'broadcast.playerChartCaption':
    'Two systems, two scales: the CXA replaced 等级分 ratings with tournament points in January 2026, so the series do not join.',
  'broadcast.playersFilterTitle': 'Title',
  'broadcast.playersAnyTitle': 'Any title',
  'broadcast.playersUntitled': 'No title',
  'broadcast.playersFilterGroup': 'List',

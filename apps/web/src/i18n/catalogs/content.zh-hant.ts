...
export const ZH_HANT_CONTENT = {
  ...
  'terms.patronPrefix':
    '核心對局始終免費。贊助是可選的：你選擇一個以美元計的金額，按月扣款直到你取消，或只付一次。它帶來的只是一個裝飾性徽章，絕不是對局優勢；單次付款每 5 美元保留徽章一個月。Mistboard 不是註冊慈善機構，所以贊助不能抵稅。目前金額見',
  'terms.patronLink': '支持',
  'terms.patronSuffix': '。',
  ...
  'patron.heroSubtitle': '可選的按月訂閱或單次付款。沒有廣告，沒有付費變強，核心功能始終免費。',
  'patron.frequencyMonthly': '按月',
  'patron.frequencyOnce': '單次',
  'patron.intro':
    'Mistboard 是一個獨立、無廣告的象棋與變體對弈網站。核心的對弈與學習功能對所有人免費，並會一直免費。贊助會員是可選的按月訂閱或單次付款，會在你的資料頁上加一個徽章。',

...
export const ZH_HANS_CONTENT = {
  ...
  'faq.heading': '常见问题',
  'faq.playWebQuestion': '有网页版吗？需要下载吗？',
  'faq.playWebAnswer':
    'Mistboard 就是网页版。打开浏览器就能下棋，电脑和手机都可以，无需下载或安装。',
  'faq.playComputerQuestion': '可以和电脑下吗？',
  'faq.playComputerAnswer':
    '可以。人机对战有八个难度等级，从入门到很强，最强的对手是皮卡鱼（Pikafish）引擎。',
  'faq.playBotsLink': '挑选等级',
  'faq.playFriendQuestion': '怎么和朋友下？',
  'faq.playFriendAnswer': '开始对局时选择和朋友对弈，把链接发给朋友，对方打开链接就能入座。',
  'faq.playOtherQuestion': '还有哪些玩法？',
  'faq.playOtherAnswer': '揭棋、暗棋、斗兽棋，以及原子象棋、鸭子象棋等原创变体。',
  'faq.playReviewQuestion': '下完可以复盘吗？',
  'faq.playReviewAnswer': '可以。象棋对局结束后可以进入复盘，引擎会标出决定胜负的几步。',
  ...
  'terms.patronPrefix':
    '核心对弈始终免费。赞助是可选的：你选择一个以美元计的金额，按月扣款直到你取消，或只付一次。它带来的只是一个装饰性徽章，绝不是对局优势；单次付款每 5 美元保留徽章一个月。Mistboard 不是注册慈善机构，所以赞助不能抵税。当前金额见',
  'terms.patronLink': '支持',
  'terms.patronSuffix': '。',
  ...
  'patron.heroSubtitle': '可选的按月订阅或单次付款。没有广告，没有付费变强，核心功能始终免费。',
  'patron.frequencyMonthly': '按月',
  'patron.frequencyOnce': '单次',
  'patron.intro':
    'Mistboard 是一个独立、无广告的象棋与变体对弈网站。核心的对弈与学习功能对所有人免费，并会一直免费。赞助会员是可选的按月订阅或单次付款，会在你的资料页上加一个徽章。',

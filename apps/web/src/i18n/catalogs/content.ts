...
export const EN_CONTENT = {
  ...
  'changelog.intro':
    'Every change to mistboard.com, month by month, newest first, each line linking the commit that made it. The highlights are on',
  'changelog.feedLink': 'Updates',
  'changelog.sourcePrefix': 'The record itself is',
  'changelog.sourceLink': 'CHANGELOG.md in the repository',
  'changelog.monthsLabel': 'Months',
  'changelog.sentenceEnd': '.',
  'changelog.feedFooter': 'Every change, month by month, is in the',
  'patron.heading': 'Mistboard Patron',
  'patron.heroTitle': 'Become a Mistboard Patron.',
  'patron.heroSubtitle':
    'An optional monthly subscription or a one-time payment. No ads, no pay-to-win, and core play stays free.',
  'patron.frequencyMonthly': 'Monthly',
  'patron.frequencyOnce': 'One-time',
  'patron.intro':
    'Mistboard is an independent, ad-free site for xiangqi and its variants. Core play and learning are free for everyone and stay that way. Patron is an optional monthly subscription, or a one-time payment, that adds a badge to your profile.',
  ...
  'about.activityFullStats': 'Full statistics',
  'stats.heading': 'Statistics',
  'stats.lede':
    'How much gets played here. Games between people or against the bots, counted when they finish; engine matches and test games are left out.',
  'stats.gamesPlayed': 'Games played',
  'stats.gamesThisMonth': '+{count} in the last 30 days',
  'stats.accounts': 'Registered players',
  'stats.inPlay': 'In play now',
  'stats.gamesPerWeek': 'Games per week',
  'stats.gamesPerWeekLabel': 'Completed games per week, most recent {count} weeks',
  'stats.gamesPerWeekSeries': 'Games',
  'stats.gamesOverTime': 'Games over time',
  ...
  'terms.patronPrefix':
    'Core play stays free. Patron support is optional: you pick an amount in US dollars. A subscription is charged every month until you cancel; a one-time payment is charged once. It buys a cosmetic badge, never a gameplay advantage; a one-time payment carries the badge for one month per $5. Mistboard is not a registered charity, so support is not tax-deductible. Current amounts are on ',
...
export const CRITICAL_CONTENT_I18N_KEYS = [
  ...
  'stats.inPlay',
  'stats.gamesPerWeek',
  'stats.gamesPerWeekLabel',
  'stats.gamesPerWeekSeries',
  'stats.gamesOverTime',
  'stats.byVariant',
  'stats.byMode',

...
import { darkXiangqiEnabled, luzhanqiEnabled } from './feature-flags.js';
...
describe('client feature flags', () => {
  ...
  it.each([['Luzhanqi', 'VITE_LUZHANQI_ENABLED', luzhanqiEnabled]])(
    'keeps %s disabled in dev unless explicitly opted in',
